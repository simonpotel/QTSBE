...
async def save_json_and_image(json_data, data_file, strategy):
    ...
    # name file
    plot_html_filename = f'display/python/saved_results/{data_file}_{strategy}.html'
...
def generate_plot_figure(json_data, data_file, strategy):
    ...
    fig = make_subplots(rows=rows, cols=cols, shared_xaxes=True, vertical_spacing=0.25,row_heights=row_heights, column_widths=column_widths)
